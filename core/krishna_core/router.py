...
class ModelRouter:
    ...
    def cloud(self, prompt):
        ...
        req=urllib.request.Request(settings.cloud_api_url,data=body,headers={"Content-Type":"application/json","Authorization":"Bearer "+settings.cloud_api_key})
        with urllib.request.urlopen(req,timeout=90) as r:
    ...
    def auto(self, prompt):
        try:
            ...
            if out.strip(): return {"provider":"local","text":out}
        except Exception:
            pass
